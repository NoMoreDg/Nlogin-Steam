...
set "mcc=brosu"
set "wse=c123456"
if %conturi%==1 set "wse=c1"
if %conturi%==2 set "wse=c12"
if %conturi%==3 set "wse=c123"
if %conturi%==4 set "wse=c1234"
if %conturi%==5 set "wse=c12345"
if %conturi%==6 set "wse=c123456"
if %wse%==c1 goto wse1
if %wse%==c12 goto wse2
if %wse%==c123 goto wse3
if %wse%==c1234 goto wse4
if %wse%==c12345 goto wse5
if %wse%==c123456 goto wse6
goto stt
:wse1
set "us1=%us1c%"
set "us2=*"
...
if %errorlevel%==2 goto 1l
if %errorlevel%==3 goto 2l
if %errorlevel%==4 goto 3l
if %errorlevel%==5 goto 4l
if %errorlevel%==6 goto 5l
if %errorlevel%==7 goto 6l
:1l
cls
